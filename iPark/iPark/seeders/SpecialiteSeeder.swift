...
struct SpecialiteSeeder {
    let specialites: [String] = [
        ...
        ,"gériatre", "médecin spécialiste en médecine physique", "gastro-entérologue", "urologue", "gynécologue", "sexologue",
         ...
         "cardiologue", "chirurgien-dentiste", "ergothérapeute", "psychomotricien",
         "pédicure-podologue", "diététicien(ne)", "orthoptiste"
    ]
